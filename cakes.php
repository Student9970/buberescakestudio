            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/Butter_Scotch_Cake.jpg">
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/cheese_cake.jpg">
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/choco_cake.jpg">
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/mango_cake.jpg">
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/mango_strawberry.jpg">
                </div>

                <div class="col-2"></div>

                <div class="itemdetails col-4">
                  <h3>Mango Strawberry Cake</h3>
                  <p>Includes Egg | 550 g</p>
                  <h4>&#x20B9; 350</h4>
                  <a><div class="submitbtn btn btn-success">Buy Now!</div></a>
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/oreo_cake.jpg">
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/rainbow_cake.jpg">
                </div>
          ...
          <div class="col-12">
            ...
            <div class="thebox container">
              ...
              <div class="item d-flex justify-content-center align-items-center row">
                ...
                <div class="itemimage col-6">
                  <img src="./images/Cake/vanilla_cake.jpg">
                </div>
